...
# Cloud SQL for PostgreSQL: Qwik Star
### Google Cloud Skills Boost - Lab GSP152

[![Open Lab](https://img.shields.io/badge/▶️_Open_Lab-4285F4?style=for-the-badge&logo=googlecloud&logoColor=white)](https://www.cloudskillsboost.google/games/6466/labs/40656)
...
This lab covers managed relational database services on Google Cloud. You'll work with Cloud SQL to deploy, configure, and manage database instances with high availability and automated backups.
...
```bash
curl -LO raw.githubusercontent.com/eccentriccoder01/Google-Arcade-Labs-EduLinkUp/refs/heads/main/Cloud%20SQL%20for%20PostgreSQL-%20Qwik%20Start/EduLinkUp.sh
