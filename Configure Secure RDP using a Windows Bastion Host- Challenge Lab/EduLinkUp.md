...
### Google Cloud Skills Boost - Lab GSP303

[![Open Lab](https://img.shields.io/badge/▶️_Open_Lab-4285F4?style=for-the-badge&logo=googlecloud&logoColor=white)](https://www.skills.google/catalog_lab/1080)
...
This challenge lab tests your skills in Configure Secure RDP using a Windows Bastion Host. You'll be presented with a set of tasks to complete without step-by-step instructions, demonstrating your ability to apply Google Cloud concepts and services in real-world scenarios.
...
```bash
curl -LO raw.githubusercontent.com/theeccentriccoder01/Google-Arcade-Labs-EduLinkUp/refs/heads/main/Configure%20Secure%20RDP%20using%20a%20Windows%20Bastion%20Host-%20Challenge%20Lab/EduLinkUp.sh
